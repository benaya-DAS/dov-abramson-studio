      ...
      <div className="max-h-[80vh] w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-xl">
        ...
        <div className="max-h-[60vh] overflow-y-auto p-5">
          ...
          <button
            ...
            className="flex w-full flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-300 py-8 text-slate-500 hover:border-brand-400 hover:text-brand-600"
          >
            <Upload size={24} />
          ...
          {status === "parsing" && <p className="mt-3 text-xs text-slate-400">קורא קובץ...</p>}
                  ...
                  <tbody>
                    {rows.slice(0, 100).map((r, i) => (
                      <tr key={i} className="border-t border-slate-100">
                        ...
                        <td className="px-2 py-1 text-slate-400">{r.rawText}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
