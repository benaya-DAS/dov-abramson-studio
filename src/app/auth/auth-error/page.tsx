...
export default async function AuthErrorPage({
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-2xl border border-red-200 bg-white p-8 text-center shadow-panel">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-red-50 text-2xl">
          🚫
        </div>
        <h1 className="text-lg font-bold text-slate-900">הגישה נדחתה</h1>
